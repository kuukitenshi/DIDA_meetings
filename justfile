...
server-A-0:
    cd server
    mvn exec:java -Dexec.args="8000 0 A 2"
server-A-1:
    cd server
    mvn exec:java -Dexec.args="8000 1 A 2"
server-A-2:
    cd server
    mvn exec:java -Dexec.args="8000 2 A 2"

# Start servers with scheduler B
server-B-0:
    cd server
    mvn exec:java -Dexec.args="8001 0 B 2"
server-B-1:
    cd server
    mvn exec:java -Dexec.args="8001 1 B 2"
server-B-2:
    cd server
    mvn exec:java -Dexec.args="8001 2 B 2"

# Start client
client:
    cd app
    mvn exec:java -Dexec.args="1 localhost 8000 A"

# Start console
console:
    cd console
    mvn exec:java -Dexec.args="localhost 8000 A"